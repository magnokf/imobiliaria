...
<div class="dash_login">
    <div class="dash_login_left">
        <article class="dash_login_left_box">
            ...
            <footer>
                <p>Desenvolvido por <a href="https://www.bestdmrsolutions.com" target="_blank">www.<b>bestdmrsolutions</b>.com</a></p>
                <p>&copy; <?= date("Y"); ?> - Todos os Direitos Reservados</p>
                <p class="dash_login_left_box_support">
                    <a target="_blank"
                       class="icon-whatsapp transition text-green"
                       href="https://api.whatsapp.com/send?phone=55+21+981155638&text=Olá, preciso de ajuda com o login."
